...
func (in *VectorAggregatorSources) DeepCopy() *VectorAggregatorSources {
	...
	out := new(VectorAggregatorSources)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VectorAggregatorSourcesAMQP) DeepCopy() *VectorAggregatorSourcesAMQP {
	...
	out := new(VectorAggregatorSourcesAMQP)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VectorAggregatorSourcesS3) DeepCopy() *VectorAggregatorSourcesS3 {
	...
	out := new(VectorAggregatorSourcesS3)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VectorAggregatorSpec) DeepCopyInto(out *VectorAggregatorSpec) {
	*out = *in
	...
	if in.Sources != nil {
		...
		*out = make([]VectorAggregatorSources, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Sinks != nil {
		in, out := &in.Sinks, &out.Sinks
		*out = make([]VectorAggregatorSinks, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *VectorPipelineSinksLoki) DeepCopyInto(out *VectorPipelineSinksLoki) {
	*out = *in
	...
	if in.ExceptFields != nil {
		in, out := &in.ExceptFields, &out.ExceptFields
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
func (in *VectorPipelineSourcesKafka) DeepCopy() *VectorPipelineSourcesKafka {
	...
	out := new(VectorPipelineSourcesKafka)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VectorPipelineSourcesVector) DeepCopy() *VectorPipelineSourcesVector {
	...
	out := new(VectorPipelineSourcesVector)
	in.DeepCopyInto(out)
	return out
}
